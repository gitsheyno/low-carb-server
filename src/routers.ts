...
const fetched = [
  {
    ...
    tags: [
      'chicken-free', 'egg-free',
      'fish-free',    'gluten-free',
      'keto',         'kid-friendly',
      'lchf',         'meal-plan-ok',
      'peanut-free',  'pork-free',
      'quick-easy',   'shellfish-free',
      'soy-free',     'tree-nut-free',
      'wheat-free'
    ],
    description: 'Who needs a bun when you could have a burger plate?  This meal is super easy to put together for several people.  The plate includes an addition of baby kale greens, tomatoes (which are optional), a couple slices of cheese, pickles and mayo!',
    prepareTime: 15,
    cookTime: 10,
    ingredients: [
      [Object], [Object],
    ...
    image: 'https://tinyurl.com/2p82zzca/a276502d-6022-47c3-ad03-ac78bd7b8c25.png'
  },
  {
  ...
  },
  {
    ...
    image: 'https://tinyurl.com/2p82zzca/5ff5bdc8-1c83-4a43-9014-be20f2bed7aa.png'
  },
  {
    ...
    description: 'These simple zucchini boats are loaded with classic burger flavors of beef, onion, tomato and cheese.\n' +
      '\n' +
    ...
    image: 'https://tinyurl.com/2p82zzca/d754c8de-acd6-41d9-8280-5984dbab34d8.png'
  },
  {
    ...
    image: 'https://tinyurl.com/2p82zzca/17e12c70-eb59-4849-bfb3-f6eaef332ceb.png'
  }
]

const createdMeals = fetched.map(({id,name ,image,nutrients,description,servings,cookTime})=>(
  {id,name,image,caloriesKCal : nutrients['caloriesKCal'],protein : nutrients['protein'],carbs : nutrients['totalCarbs'], fat : nutrients['fat'],description,servings,cookTime}
))
  ...
  console.log("user in where",user)
...
router.post("/dashboard/meals",async(req,res)=>{
  ...
  //   }
  // })
  console.log("meals" , req.body.data)
...
router.get("/dashboard/meals",async(req,res)=>{
  const id = req.params.id;
    ...
    console.log("final" , newMealObject)
    res.status(200).json({data :  newMealObject})
